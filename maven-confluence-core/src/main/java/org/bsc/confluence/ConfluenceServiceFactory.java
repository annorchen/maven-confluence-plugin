...
public class ConfluenceServiceFactory {
	...
	private static class MixedConfluenceService implements ConfluenceService {
		...
		public Model.Attachment addAttchment(Model.Page page, Model.Attachment attachment, File source) throws Exception {
			return restService.addAttchment(page, attachment, source);
//			return xmlrpcService.addAttchment(page, attachment, source);
		...
		public Model.Page storePage(Model.Page page, Storage content) throws Exception {
			...
			if (page.getId() == null) {
				final JsonObjectBuilder inputData = restService.jsonForCreatingPage(page.getSpace(), Integer.valueOf(page.getParentId()), page.getTitle());
		...
		public Model.Attachment getAttachment(String pageId, String name, String version) throws Exception {
			return restService.getAttachment(pageId, name, version);
	...
	public static ConfluenceService createInstance(String endPoint, Credentials credentials, ConfluenceProxy proxyInfo, SSLCertificateInfo sslInfo)
			throws Exception {
